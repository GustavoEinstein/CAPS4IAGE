      ...
      <nav style={styles.nav}>
        ...
        <ul style={styles.ul}>
          <li>
            ...
            >
              <LayoutDashboard size={20} style={styles.icon} /> Início
            </NavLink>
          </li>
          <li>
            <NavLink
              ...
              onClick={isMobile ? onClose : undefined}
            >
              <FilePlus2 size={20} style={styles.icon} /> Catalogar Produção
            </NavLink>
          </li>
          <li>
            <NavLink
              ...
              onClick={isMobile ? onClose : undefined}
            >
              <FolderOpen size={20} style={styles.icon} /> Minhas Produções
            </NavLink>
          </li>
          <li>
            <NavLink
              ...
              onClick={isMobile ? onClose : undefined}
            >
              <Scale size={20} style={styles.icon} /> Revisão (Duplo Cego)
            </NavLink>
          </li>
          <li>
            <NavLink
              ...
              onClick={isMobile ? onClose : undefined}
            >
              <MessageSquare size={20} style={styles.icon} /> Fórum de Rascunhos
            </NavLink>
          </li>
          <li>
            <NavLink
              ...
              onClick={isMobile ? onClose : undefined}
            >
              <Trophy size={20} style={styles.icon} /> Hall da Fama
            </NavLink>
          </li>
        </ul>
            ...
            <ul style={styles.ul}>
              <li>
                <NavLink
                  ...
                  onClick={isMobile ? onClose : undefined}
                >
                  <Settings size={20} style={styles.icon} /> Central do Admin
                </NavLink>
              </li>
            </ul>
          </>
          ...
          <ul style={styles.ul}>
            <li>
              <a
                ...
                onClick={isMobile ? onClose : undefined}
              >
                <ClipboardList size={20} style={styles.icon} /> Avaliar o
                Sistema
              </a>
            </li>
            <li>
              <NavLink
                ...
                onClick={isMobile ? onClose : undefined}
              >
                <LifeBuoy size={20} style={styles.icon} /> Ajuda e Suporte
              </NavLink>
            </li>
          </ul>
        </div>
...
const styles = {
  ...
  footer: { padding: "20px", borderTop: "1px solid var(--border-color)" },
  proCard: {
