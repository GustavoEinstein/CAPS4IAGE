          ...
          <div style={styles.pillarsGrid}>
            ...
            <div style={styles.pillarCard}>
              ...
              <p>
                ...
                pedagógica, livre de vieses pessoais.
              </p>
            </div>
            <div style={styles.pillarCard}>
              <div style={styles.pillarIcon}>
              ...
              <p>
                ...
                burocracia e ampliar a criatividade.
              </p>
            </div>
          </div>
        </div>
        ...
        <div style={styles.aboutContainer}>
          <div style={styles.aboutText}>
            ...
            <p style={styles.paragraph}>
              ...
              terreno novo e, por vezes, intimidante. O <strong>T.E.I.A</strong>{" "}
              nasceu para ser o laboratório seguro onde essa inovação acontece.
            </p>
            <p style={styles.paragraph}>
              Ao catalogar suas produções, você não está apenas guardando
              arquivos. Você está treinando uma base de conhecimento coletiva,
              ajudando outros docentes a entenderem{" "}
              <em>quais prompts funcionam</em>,{" "}
              <em>quais IAs são melhores para cada disciplina</em> e como
              alinhar tudo isso à <strong>BNCC</strong>.
            </p>
          ...
          <div style={styles.faqGrid}>
            <div style={styles.faqCard}>
              ...
              <p style={styles.faqAnswer}>
                Sim. O T.E.I.A é uma iniciativa voltada para o fortalecimento da
                educação pública e privada, sem custo para professores.
              </p>
            </div>
            <div style={styles.faqCard}>
              <h4 style={styles.faqQuestion}>
                Quem pode revisar as atividades?
              </h4>
              <p style={styles.faqAnswer}>
                Apenas professores da mesma área de conhecimento. Um professor
                de Matemática só revisa produções de Matemática, garantindo a
                tecnicidade da avaliação.
              </p>
            </div>
            <div style={styles.faqCard}>
              <h4 style={styles.faqQuestion}>Preciso ser expert em IA?</h4>
              <p style={styles.faqAnswer}>
                Não. A plataforma foi desenhada justamente para quem está
                começando. Nossas ferramentas auxiliam na formatação e
                estruturação.
              </p>
            </div>
            <div style={styles.faqCard}>
              ...
              <p style={styles.faqAnswer}>
                Sim. Utilizamos criptografia padrão e respeitamos a LGPD. Seus
                planos de aula só se tornam públicos após sua aprovação final.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer style={styles.footer}>
        <div style={styles.container}>
          ...
          <div style={styles.footerBottom}>
            © 2026 T.E.I.A Inc. Todos os direitos reservados.
          </div>
        </div>
      </footer>
          ...
          <div style={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            ...
            {activeModal === "terms" && (
              <>
                ...
                <div style={styles.modalBody}>
                  <p>
                    Bem-vindo ao CAPSIAGE. Ao utilizar nossa plataforma, você
                    concorda com os seguintes termos:
                  </p>
                  <ul>
                    <li>
                      <strong>Respeito e Colaboração:</strong> A comunidade se
                      baseia no respeito mútuo. Comentários ofensivos nas
                      revisões não serão tolerados.
                    </li>
                    <li>
                      <strong>Conteúdo Original:</strong> Você garante que o
                      material submetido é de sua autoria ou que possui direitos
                      de uso.
                    </li>
                    <li>
                      <strong>Uso Educacional:</strong> Os materiais disponíveis
                      são exclusivamente para fins educacionais e não
                      comerciais.
                    </li>
                    <li>
                      <strong>Revisão Duplo-Cego:</strong> Você aceita que seu
                      material será revisado anonimamente e, se aprovado,
                      publicado na plataforma.
                    </li>
                  </ul>
                  <p>
                    O descumprimento destas regras pode levar à suspensão da
                    conta.
                  </p>
                </div>
              </>
            ...
            {activeModal === "privacy" && (
              <>
                ...
                <div style={styles.modalBody}>
                  <p>
                    Sua privacidade é fundamental para nós. Veja como tratamos
                    seus dados:
                  </p>
                  <ul>
                    <li>
                      <strong>Coleta de Dados:</strong> Coletamos apenas nome,
                      e-mail e dados profissionais para funcionamento do
                      sistema.
                    </li>
                    <li>
                      <strong>Anonimato:</strong> No processo de revisão, sua
                      identidade é ocultada para garantir imparcialidade.
                    </li>
                    <li>
                      <strong>Compartilhamento:</strong> Não vendemos nem
                      compartilhamos seus dados com terceiros para fins
                      publicitários.
                    </li>
                    <li>
                      <strong>LGPD:</strong> Você tem o direito de solicitar a
                      exclusão de seus dados a qualquer momento através do nosso
                      suporte.
                    </li>
                  </ul>
                </div>
