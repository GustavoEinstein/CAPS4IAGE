...
import { 
    ...
    Lightbulb, 
    Users,
    Trophy // Ícone para destacar os mais populares
} from 'lucide-react';

// --- DADOS MOCK (UNIVERSO COESO) ---
const DADOS_MOCK = [
    // 1. O SEU CASO DE SUCESSO (Linkado com 'Minhas Atividades')
    { 
        id: "filosofia-01", 
    ...
    // 2. O ITEM QUE VOCÊ REVISOU (Linkado com 'Histórico de Revisão')
    { 
        id: "matematica-10", 
    ...
    // 3. OUTROS ITENS DE VITRINE (Populares na Plataforma)
    { 
        id: "historia-02", 
    ...
    { 
        id: "ciencias-03", 
        titulo: "Ciclo da Água: Roteiro de Experiência", 
        disciplina: "Ciencias", 
        nivel: "Fundamental 1", 
        modelo_ia: "Copilot", 
    ...
    { 
        ...
        nivel: "Ensino Médio", 
        modelo_ia: "Claude 3", 
        categoria: "PBL (Problemas)", 
        favorito: true, 
        resumo: "A IA gerou 5 cenários de testes de DNA com alelos complexos. Os alunos tiveram que deduzir a paternidade e explicar o raciocínio mendeliano.", 
        likes: 78 
    }
];
...
const Inicio = () => {
    ...
    return (
        // WRAPPER DE FUNDO CINZA (Consistência Visual)
                ...
                <div style={{
                    ...
                    <div style={{...styles.heroContent, textAlign: isMobile ? 'left' : 'center'}}>
                        ...
                        <div style={styles.searchWrapper}>
                            <input 
                                type="text" 
                                placeholder={isMobile ? "Buscar prática..." : "Pesquise por disciplina, tema ou metodologia..."} 
    ...
    return (
        ...
        >
            ...
            <div style={styles.cardBody}>
                ...
                {/* Resumo da Prática (Texto com ícone) */}
            ...
            <div style={styles.cardFooter}>
                <div style={styles.categoryInfo}>
                    <Users size={16} color="#78909C" style={{marginRight: '6px'}} />
...
// --- ESTILOS CORRIGIDOS (Clean & Consistent) ---
const styles = {
    ...
    // CARD (Borda corrigida)
    card: { 
        backgroundColor: '#FFFFFF', 
        borderRadius: '12px', 
        border: '1px solid #E0E0E0', // Cor explícita
    ...
    cardHover: { 
        ...
        borderColor: '#42A5F5' // Cor do Hover
    },
