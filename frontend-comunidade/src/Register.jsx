    ...
    import api from './services/api'; // <--- USANDO NOSSA API CENTRAL
    ...
    const Register = () => {
        ...
        const [formData, setFormData] = useState({
            ...
            password: '',
            confirmPassword: '',
            disciplina: '' // <--- Campo obrigatório inicializado vazio
        });
        ...
        const handleRegister = async (e) => {
            ...
            try {
                ...
                await api.post('api/register/', {
                    ...
                    disciplina: formData.disciplina // <--- Enviando a disciplina!
                });
                ...
                <div style={styles.container}>
                    ...
                    <div style={styles.sidebar}>
                        ...
                        <div style={styles.featureItem}>
                            ...
                            <span>Acesso gratuito vitalício</span>
                        </div>
                        <div style={styles.featureItem}>
                            <CheckCircle2 size={18} color="#BBDEFB" /> 
                            ...
                            <div style={styles.inputGroup}>
                                ...
                                <div style={styles.inputWrapper}>
                                    ...
                                    <select 
                                        ...
                                        onChange={handleChange}
                                        style={styles.select} // Usando estilo novo
                                        required
                                    >
    ...
    const styles = {
        ...
        // 3. ESTILO NOVO DO SELECT (Para ficar bonito igual os inputs)
        select: {
            border: 'none', background: 'transparent', outline: 'none', width: '100%',
